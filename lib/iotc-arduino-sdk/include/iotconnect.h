...
typedef struct {
    ...
    union {
        ...
        // reserved for future auth types
    } data;
} IotConnectAuthInfo;

typedef struct {
    WiFiClientSecure *net; // TODO: Check ethernet support
    size_t mqtt_buffer_size; // Buffer size for PubSubClient MQTT implementation. if set to 0 (default) it will be 2048
